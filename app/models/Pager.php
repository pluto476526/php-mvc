...
class Pager
{
     ...
     *
     * @param int|null $record_count The total number of records. If null, it will default to the limit.
     * @return void
     */
    public function display($record_count = null)
    {
        // If record_count is null, default to the limit
        if ($record_count == null) {
            $record_count = $this->limit;
        }

        // Only display pagination if there are more records than the limit or if it's not the first page
                ...
                <nav class="<?= $this->nav_class ?>" style="<?= $this->nav_styles ?>">
                    <ul class="<?= $this->ul_class ?>" style="<?= $this->ul_styles ?>">
                        <li class="<?= $this->first_li_class ?>" style="<?= $this->first_li_styles ?>">
                            <a class="<?= $this->first_a_class ?>" style="<?= $this->first_a_styles ?>" href="<?= $this->links['first'] ?>">
                                First
                            </a>
                        </li>
                        ...
                        <li class="<?= $this->next_li_class ?>" style="<?= $this->next_li_styles ?>">
                            <a class="<?= $this->next_a_class ?>" style="<?= $this->next_a_styles ?>" href="<?= $this->links['next'] ?>">
                                Next
                            </a>
                        </li>
                    </ul>
